...
@router.put(
        ...
        description="Изменяет название, эмодзи и/или родительскую категорию. "
                "Через `parent_id` можно назначить ранее созданной категории родителя "
                "(например, сделать существующую категорию подкатегорией другой) "
                "или снять родителя, передав `parent_id: null`. "
                "Родительской может быть только категория без собственного родителя "
                "(максимум 2 уровня вложенности), и категория с подкатегориями "
                "сама не может стать подкатегорией.",
