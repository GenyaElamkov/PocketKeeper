...
class TransactionRequest(BaseModel):
    ...
    date_from: date | None = Field(None, description="Дата создания транзакции от")
    date_to: date | None = Field(None, description="Дата создания транзакции до")
    ...
    transaction_type: TransactionType | None = Field(None, description="Тип транзакции (доходы/расходы)")
